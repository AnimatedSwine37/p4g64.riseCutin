...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[Rise Cutins] {message}");
    }
    ...
    {
        _logger.WriteLine($"[Rise Cutins] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Rise Cutins] {message}", System.Drawing.Color.Red);
    }
